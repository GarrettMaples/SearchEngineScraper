...
namespace SearchEngineScraper.Api.Models.Requests
{
    ...
    /// </summary>
    /// <param name="Search">The keyword(s) to search Google for. This can be multiple keywords.
    /// It will be submitted to Google verbatim.</param>
    /// <param name="Url">The URL to search for in the Google results.
    /// This is a wildcard search and will match the URL on any portion of this parameter</param>
